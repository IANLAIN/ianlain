...
export const translations = {
    en: {
        ...
        interests: {
            ...
            linux: {
                title: "Linux",
                description: "Open-source systems, command-line mastery, and Linux in development and system administration."
            },
            astronomy: {
                title: "Astronomy",
    ...
    es: {
        ...
        interests: {
            ...
            linux: {
                title: "Linux",
                description: "Sistemas de código abierto, dominio de la línea de comandos y el poder de Linux en el desarrollo y administración de sistemas."
            },
            astronomy: {
                title: "Astronomía",
    ...
    fr: {
        ...
        about: {
            ...
            paragraph1: "Étudiant en génie des systèmes et informatique à l'Universidad Tecnológica de Pereira, Colombie. Motivé par la curiosité sur les systèmes informatiques et la résolution de problèmes complexes.",
            paragraph2: "Basé dans la région caféière de Colombie, combinant études techniques avec appréciation des mathématiques et de l'astronomie.",
            education: {
                title: "Éducation",
        ...
        interests: {
            ...
            linux: {
                title: "Linux",
                description: "Systèmes open-source, maîtrise de la ligne de commande et la puissance de Linux dans le développement et l'administration système."
            },
            astronomy: {
                title: "Astronomie",
    ...
    zh: {
        ...
        hero: {
            subtitle: "系统与计算机工程专业学生",
            description: "热爱计算机科学、数学与天文学"
        },
        about: {
            title: "关于我",
            paragraph1: "哥伦比亚佩雷拉科技大学系统与计算机工程专业学生。对计算系统充满好奇，致力于解决复杂问题。",
            paragraph2: "居住在哥伦比亚咖啡产区，将技术研究与数学和天文学的鉴赏相结合。",
            education: {
                title: "教育背景",
                degree: "系统与计算机工程",
        ...
        interests: {
            ...
            linux: {
                title: "Linux",
                description: "开源系统、命令行掌握以及Linux在开发和系统管理中的应用。"
            },
            astronomy: {
                title: "天文学",
